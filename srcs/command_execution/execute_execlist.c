...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/10 14:52:31 by krchuaip          #+#    #+#             */
...
int	execute_pipeline(t_list_bi *pipeline_cmds, t_info *info)
{
	int				exit_status;
 ...
 * 		pipeline_i : t_list_bi
 * 		cmd_ij : t_command_info
 */

bool	is_execute_exit(t_list_bi *pipeline_cmds)
{
