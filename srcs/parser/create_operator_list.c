...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/10 14:58:28 by krchuaip          #+#    #+#             */
...
t_exec_list **prev_pipe, t_list_bi **popped, t_token_elem *tok_elem)
{
...
static int	setting_params(t_list_bi **tokenlst_head, \
...
int	create_operator_list(t_list_bi **tokenlst_head, t_exec_list **execlst_head)
{
	int				subshell_depth;
	int				handle_result;
